      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          {CORE_PROBLEMS.map((item) => (
            <div
              key={item.id}
              className="p-6 sm:p-7 rounded-3xl bg-slate-50/70 border border-slate-200 hover:border-slate-300 transition-all space-y-4 shadow-sm"
            >
              ...
              <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-200/80 text-xs sm:text-sm text-emerald-900 leading-relaxed flex items-start gap-2.5 font-medium">
        ...
        <div className="text-center pt-2">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-slate-100 border border-slate-200 text-slate-700 text-xs font-bold">

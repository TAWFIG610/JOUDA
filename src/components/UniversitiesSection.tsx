...
import { Sparkles, MapPin, Award, CheckCircle2, ArrowLeft, MessageSquare } from 'lucide-react';

interface UniversitiesSectionProps {
  onOpenLeadModal: (source?: string) => void;
}

export const UniversitiesSection: React.FC<UniversitiesSectionProps> = ({ onOpenLeadModal }) => {
  ...
  const renderOfficialLogo = (uniId: string, shortName: string, accent: string) => {
    switch (uniId) {
      case 'um':
        return (
          <svg className="w-10 h-10 shrink-0" viewBox="0 0 48 48" fill="none">
            <rect width="48" height="48" rx="12" fill="#1E3A8A" />
            <path d="M14 14H34V20C34 26.6274 29.5228 32 24 32C18.4772 32 14 26.6274 14 20V14Z" fill="#F59E0B" />
            <path d="M18 18H30V21C30 24.3137 27.3137 27 24 27C20.6863 27 18 24.3137 18 21V18Z" fill="#1E3A8A" />
      ...
      case 'apu':
        return (
          <svg className="w-10 h-10 shrink-0" viewBox="0 0 48 48" fill="none">
            ...
            <polygon points="24,12 35,32 30,32 24,20 18,32 13,32" fill="#FFFFFF" />
      ...
      case 'sunway':
        return (
          <svg className="w-10 h-10 shrink-0" viewBox="0 0 48 48" fill="none">
            ...
            <path d="M24 16V32M16 24H32" stroke="#FBBF24" strokeWidth="3" strokeLinecap="round" />
          </svg>
        );
      case 'ukm':
        return (
          <svg className="w-10 h-10 shrink-0" viewBox="0 0 48 48" fill="none">
            ...
            <path d="M15 15H33V23C33 28 29 33 24 33C19 33 15 28 15 23V15Z" fill="#FBBF24" />
            <path d="M19 19H29V23C29 25.7614 26.7614 28 24 28C21.2386 28 19 25.7614 19 23V19Z" fill="#7C3AED" />
          </svg>
        );
      case 'utm':
        return (
      ...
      case 'ucsi':
        return (
          <svg className="w-10 h-10 shrink-0" viewBox="0 0 48 48" fill="none">
            ...
            <path d="M16 16H22V26C22 28.5 24 30 26.5 30C29 30 31 28.5 31 26V16H37V26C37 32 32.5 35 26.5 35C20.5 35 16 32 16 26V16Z" fill="#FFFFFF" />
          </svg>
        );
      case 'upm':
        return (
          <svg className="w-10 h-10 shrink-0" viewBox="0 0 48 48" fill="none">
            ...
            <path d="M15 15H33V24C33 29 29 33 24 33C19 33 15 29 15 24V15Z" fill="#DC2626" />
      ...
      case 'mmu':
        return (
          <svg className="w-10 h-10 shrink-0" viewBox="0 0 48 48" fill="none">
            ...
            <path d="M14 16L24 25L34 16V32H29V23L24 28L19 23V32H14V16Z" fill="#F97316" />
          </svg>
        );
      case 'uniten':
        return (
      ...
      case 'monash':
        return (
          <svg className="w-10 h-10 shrink-0" viewBox="0 0 48 48" fill="none">
            ...
            <path d="M16 16H32V23C32 28 28 32 24 32C20 32 16 28 16 23V16Z" fill="#FFFFFF" />
            <path d="M20 20H28V23C28 25.2 26.2 27 24 27C21.8 27 20 25.2 20 23V20Z" fill="#0369A1" />
      ...
      case 'nottingham':
        return (
          <svg className="w-10 h-10 shrink-0" viewBox="0 0 48 48" fill="none">
            ...
            <path d="M15 15H33V20C33 25.5 29 30 24 30C19 30 15 25.5 15 20V15Z" fill="#FFFFFF" />
            <path d="M19 18H29V20C29 22.8 26.8 25 24 25C21.2 25 19 22.8 19 20V18Z" fill="#047857" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mb-10">
        ...
        <div className="text-center space-y-3.5 max-w-3xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight">
            الجامعات الماليزية التي <span className="text-gradient-emerald">نتعاقد وننسق معها مباشرة</span>
          </h2>

          <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
            نؤمن لك القبول الجامعي الرسمي من أقوى الجامعات الحكومية والخاصة وفروع الجامعات العالمية البريطانية والأسترالية في ماليزيا.
          </p>
        </div>
        ...
        <div className="rounded-3xl bg-gradient-to-r from-slate-900 via-slate-800 to-emerald-950 p-6 sm:p-8 text-white shadow-xl flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-start border border-emerald-500/20">
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
              أرسل لنا مؤهلاتك ومعدلك وسيقوم مستشار جودة بمطابقة أنسب جامعة وميزانية لك فوراً وبشكل مجاني.
            </p>
          </div>

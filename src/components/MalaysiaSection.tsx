...
export const MalaysiaSection: React.FC = () => {
  return (
    <section id="why-malaysia" className="py-20 lg:py-24 bg-white relative border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {WHY_MALAYSIA_PILLARS.map((item, idx) => (
            <div
              key={idx}
              className="p-6 rounded-3xl bg-slate-50/70 border border-slate-200 hover:border-slate-300 transition-all space-y-3 shadow-xs"
            >

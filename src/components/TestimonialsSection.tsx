...
export const TestimonialsSection: React.FC = () => {
  return (
    <section id="testimonials" className="py-12 sm:py-16 lg:py-24 bg-[#FAFCFF] relative border-t border-slate-200">
            ...
            >
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-wrap items-center justify-between gap-2">
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-medium">{t.country} • {t.university}</p>
                </div>

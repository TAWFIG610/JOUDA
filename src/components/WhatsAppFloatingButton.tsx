...
export const WhatsAppFloatingButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 start-6 z-40 group">
      {/* Tooltip */}
      <div className="absolute bottom-full start-0 mb-2 hidden group-hover:block whitespace-nowrap px-3 py-1.5 rounded-xl bg-slate-900 text-white text-xs font-bold shadow-lg border border-slate-800 animate-in fade-in slide-in-from-bottom-1">
      ...
      <a
        ...
        className="relative flex items-center justify-center w-14 h-14 rounded-full bg-emerald-500 hover:bg-emerald-600 text-white shadow-xl shadow-emerald-600/30 hover:scale-105 transition-all focus:outline-none focus:ring-4 focus:ring-emerald-300"
      >

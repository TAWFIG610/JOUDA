import type { NavLink, PartnerUniversity, StudyProgram, Testimonial, FAQItem } from '../types';
...
export const TRUST_STATS = [
  { value: '+30', label: 'جامعة ماليزية معتمدة', desc: 'شراكات وتنسيق مباشر', color: 'emerald' },
  { value: '100%', label: 'شفافية وتدقيق رسمي', desc: 'بإشراف وزارة التعليم و EMGS', color: 'blue' },
  { value: '+1,500', label: 'طالب تم توجيههم', desc: 'من مختلف الدول العربية', color: 'purple' },
  { value: '0$', label: 'رسوم الاستشارة والتقييم', desc: 'دراسة ملفك مجانية تماماً', color: 'amber' },
];
...
export const PARTNER_UNIVERSITIES: PartnerUniversity[] = [
  ...
  },
  {
    ...
    accent: '#7C3AED',
    logoBg: '#F5F3FF',
    popularFields: ['العلوم التطبيقية', 'الهندسة الكيميائية', 'العلوم الإنسانية']
  },
  {
    id: 'utm',
...
export const CORE_PROBLEMS = [
  {
    ...
    solution: 'نقدم لك دراسة ومطابقة مجانية دقيقة بناءً على ميزانيتك ومعدلك ومتطلبات سوق العمل.'
  },
  {
    id: 'fees',
    q: 'تخشى الرسوم الخفية والوسطاء غير الموثوقين؟',
    solution: 'تعامل رسمي ومباشر مع الجامعات بفواتير معتمدة وبدون أي عمولات مستترة.'
  },
  {
    id: 'visa',
    q: 'قلق من تعقيدات تأشيرة الطالب (EMGS) والمتطلبات الورقية؟',
    solution: 'فريقنا المختص يدقق مستنداتك ويتابع إصدار الموافقة الأمنية والتأشيرة خطوة بخطوة.'
  },
  {
    id: 'arrival',
    q: 'تتساءل عن ترتيبات الوصول والسكن والمعيشة في ماليزيا؟',
    solution: 'نستقبلك بالمطار، نوفر خيارات سكن آمنة، ونرافقك لإنهاء الفحص الطبي والتسجيل الجامعي.'
  }
];
...
export const STUDY_PROGRAMS: StudyProgram[] = [
  {
    ...
    accentColor: '#059669',
    description: 'أعلى التخصصات طلباً في الاقتصاد الرقمي، يشمل التعلم الآلي، الحوسبة السحابية، وتطوير الأنظمة الذكية.',
    careerPaths: ['مهندس ذكاء اصطناعي', 'مطور برمجيات متقدم', 'مهندس حلول سحابية'],
  ...
  },
  {
    ...
    level: 'بكالوريوس / ماجستير',
    accentColor: '#2563EB',
    description: 'تأهيل متقدم في حماية البيانات، كشف الاختراقات، وأمن الشبكات السحابية بمعايير عالمية.',
    careerPaths: ['محلل أمن معلومات', 'مستشار حماية سيبرانية', 'مهندس أمن شبكات'],
  ...
  },
  {
    ...
    level: 'بكالوريوس / ماجستير',
    accentColor: '#D97706',
    description: 'دمج بين علوم الإدارة الحديثة، التحليل المالي، والابتكارات الرقمية في التجارة والاستثمار.',
  ...
  },
  {
    ...
    level: 'بكالوريوس / ماجستير',
    accentColor: '#7C3AED',
    description: 'برامج هندسية معتمدة دولياً من مجلس المهندسين (BEM) واتفاقية واشنطن (Washington Accord).',
    careerPaths: ['مهندس روبوتات وميكاترونكس', 'مهندس مشاريع بنية تحتية', 'مهندس طاقة متجددة'],
  ...
  },
  {
    ...
    level: 'بكالوريوس / ماجستير',
    accentColor: '#06B6D4',
    description: 'استخراج الأنماط، تحليل البيانات الضخمة، وبناء النماذج التنبؤية للشركات والمؤسسات الدولية.',
  ...
  },
  {
    ...
    accentColor: '#E11D48',
    description: 'تعليم طبي وصيدلاني متميز بتدريب عملي في أحدث المستشفيات والمختبرات المعتمدة.',
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    quote: 'فريق جودة اختصر علي شهوراً من الحيرة. حصلت على قبولي في تيلورز خلال 5 أيام، ومتابعة الفيزا كانت سلسة جداً.',
    year: 'دفعة 2024',
    rating: 5
  },
  {
    ...
    quote: 'أكثر ما أعجبني هو الشفافية التامة. لم أدفع أي مبالغ إضافية، واستقبلوني في المطار وساعدوني في حجز سكن ممتاز.',
    year: 'دفعة 2025',
    rating: 5
  },
  {
    ...
    quote: 'التقديم في الجامعات الحكومية يحتاج دقة عالية في الأوراق. بفضل الله ثم إرشاد جودة تم قبولي في جامعة مالايا الأولى بماليزيا.',
    year: 'دفعة 2024',
    rating: 5
  }
];
...
export const FOOTER_DATA = {
  brandDesc: 'جودة (JOUDA) — بوابتك الرسمية للاستشارات والخدمات الطلابية، نرافقك من أول خطوة لاختيار التخصص وتأمين القبول الجامعي والتأشيرة حتى استقرارك في ماليزيا.',
  links: [
